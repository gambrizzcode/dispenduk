	...
	<div class="main-content-inner">
		<div class="page-content">
			...
			<div class="row">
				<div class="col-xs-12">
					<!-- PAGE CONTENT BEGINS -->
					<form enctype="multipart/form-data" action="<?php echo site_url("c_lahir/update_saksi1"); ?>" class="form-horizontal" role="form" accept="" method="POST" autocomplete="off">
						
							<input type="hidden" name="id_reg" id="id_reg" value="<?php echo $id_reg; ?>">

							<div class="form-group">
								<label class="col-sm-3 control-label">NIK Saksi 1</label>
								<div class=col-sm-5>
									<input type="text" class="form-control input-sm" name="nik_saksi1" id="nik_saksi1" required="required" value="<?php echo $nik_saksi1; ?>">
								</div>
							</div>

							<div class="form-group">
								<label class="col-sm-3 control-label">Nama Saksi 1</label>
								<div class=col-sm-5>

	...
	<div class="main-content-inner">
		<div class="page-content">
			...
			<div class="row">
				<div class="col-xs-12">
					<!-- PAGE CONTENT BEGINS -->
					<form enctype="multipart/form-data" action="<?php echo site_url("c_lahir/update_bapak"); ?>" class="form-horizontal" role="form" accept="" method="POST" autocomplete="off">
						
							<input type="hidden" name="id_reg" id="id_reg" value="<?php echo $id_reg; ?>">

							<div class="form-group">
								<label class="col-sm-3 control-label">NIK Bapak</label>
								<div class=col-sm-5>
									<input type="text" class="form-control input-sm" name="nik_bapak" id="nik_bapak" required="required" value="<?php echo $nik_bapak; ?>">
								</div>
							</div>
							...
							<div class="form-group">
								...
								<div class=col-sm-5>
									<input type="text" class="form-control input-sm" name="kewarganegaraan" id="kewarganegaraan" required="required" value="<?php echo $kewarganegaraan; ?>">
								</div>
							</div>

							<div class="form-group">
								<label class="col-sm-3 control-label">Kebangsaan</label>
								<div class=col-sm-5>
									<input type="text" class="form-control input-sm" name="kebangsaan" id="kebangsaan" required="required" value="<?php echo $kebangsaan; ?>">
								</div>
							</div>

							<div class=form-group>
								<label class="col-sm-3 control-label">Tanggal Kawin</label>
								<div class=col-sm-5>
									<input type="text" class="form-control date-picker input-sm" id="id-date-picker-1" data-date-format="yyyy-mm-dd" name="tgl_kawin" id="tgl_kawin" required="required" value="<?php echo $tgl_kawin; ?>">
								</div>
							</div>

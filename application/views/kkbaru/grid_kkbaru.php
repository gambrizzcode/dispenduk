					...
					<div class="col-md-12">
						...
						<table id="duatatuabel" class="table table-condensed table-bordered table-striped table-hover table-responsive" style="width: 100%">
							...
							<tbody>
								<?php
								$no = 1;
								foreach ($qdatakkbaru as $kdt => $vdt) {
								?>
									<tr>
										<td><?php echo $no++; ?></td>
										...
										<td>
											<div class="btn-group">
												<button class="btn btn-xs btn-success" title="Detail" onclick="location='<?php echo site_url("c_kkbaru/detail_kkbaru/".$vdt->id_reg); ?>'">
													<i class="ace-icon fa fa-search bigger-120"></i>
												</button>

												<!-- <button class="btn btn-xs btn-info" title="Edit" onclick="location='<?php //echo site_url("c_kkbaru/form_kkbaru/".$vdt->id_reg); ?>'">
													<i class="ace-icon fa fa-edit bigger-120"></i>
												</button> -->

												<button class="btn btn-xs btn-primary" title="Status" onclick="location='<?php echo site_url("c_list/status_permohonan/".$vdt->id_reg."/kkbaru"); ?>'">
													<i class="ace-icon fa fa-pencil bigger-120"></i>
												</button>

												<button class="btn btn-xs btn-danger" title="Hapus" onclick="location='<?php echo site_url("c_kkbaru/delete_kkbaru/".$vdt->id_reg); ?>'">

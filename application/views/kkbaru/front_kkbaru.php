						...
						<?php if ($ada == 0) { ?>
							<div class="row">
								<div class="col-md-12" align="center">
									<h5><b>Tekan tombol di bawah ini</b></h5>
									<h5><b>untuk melakukan pengajuan</b></h5>
									<h5><b>Permohonan Pencetakan KK Baru</b></h5>
									<br>
									<a class="btn btn-flat btn-success btn-lg" href="<?php echo site_url("c_list/form_mohon/kkbaru"); ?>">
								...
								<div class="col-md-12">
									...
									<div class="row">
										...
										<div class="col-md-4">
											<?php
											if ($kkb->id_status == "") { ?>
												<a class="btn btn-flat btn-danger" onclick="return confirm('Yakin Finalisasi ? ');" href="<?php echo site_url("c_list/finalisasi/".$kkb->id_reg."/c_kkbaru"); ?>">
												<i class="fa fa-check"></i> Finalisasi </a>
											<?php }else{ ?>
												<a class="btn btn-flat btn-success" href="<?php echo site_url("c_list/status_permohonan/".$kkb->id_reg."/kkbaru"); ?>">
									...
									<div class="row">
										<div class="col-md-12">
											Catatan:
											Sebelum mengisi form berikut, download terlebih dahulu form F101.<br>
											<a href="<?php echo base_url() ?>img/form_f101_dispendukcapil.jpg">Download Di Sini</a><br>
											Cetak Form F101 tsb, isi dengan sebenar - benarnya.
											<br>
											Kemudian Scan / foto dan upload pada form berikut.
										</div>
									</div>
									<hr>
									<div align="center" class="row">
										...
										// $id_reg = $kkb->id_reg;
										$qdata_kkbaru = "SELECT * FROM kkbaru WHERE id_reg = '$id_reg' AND nama <> ''";
										$Bariskkb = $this->M_akun->q_data($qdata_kkbaru)->num_rows();
										if ($Bariskkb == 1) { ?>
											<h4>Form Data Permohonan Terisi</h4>
											<a class="btn btn-flat btn-warning btn-sm" href="<?php echo site_url("c_kkbaru/detail_kkbaru/".$kkb->id_reg); ?>">
											<i class="fa fa-file-text-o"></i> Detail </a>
										<?php if ($Barispermohonan == 1) {}else{ ?>
											<a class="btn btn-flat btn-success btn-sm" href="<?php echo site_url("c_kkbaru/form_kkbaru/".$kkb->id_reg); ?>">
											<i class="fa fa-file-text-o"></i> Edit </a>
										<?php } ?>
										<?php }else{ ?>
											<a class="btn btn-flat btn-primary" href="<?php echo site_url("c_kkbaru/form_kkbaru/".$kkb->id_reg); ?>">

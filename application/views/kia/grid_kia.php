								...
								<div class="dataTables_length" id="DataTables_Table_0_length" style="margin-left: 10px;">
									<div class="form-group">
										<div class="col-sm-12">
											...
											<a class="btn btn-social btn-sm btn-facebook" href="<?php //echo site_url("c_list/form_mohon/kia"); ?>">
					...
					<div class="col-md-12">
						...
						<table id="duatatuabel" class="table table-condensed table-bordered table-striped table-hover table-responsive" style="width: 100%">
							...
							<tbody>
								<?php
								$no = 1;
								foreach ($qdatakia as $kdt => $vdt) {
								?>
									<tr>
										<td><?php echo $no++; ?></td>
										<td><?php echo $vdt->id_reg; ?></td>
										<td><?php echo date('d-m-Y',strtotime($vdt->tanggal)); ?></td>
										<td><?php echo $vdt->nkk; ?></td>
										<td><?php echo $vdt->nama_kk; ?></td>
										...
										<td>
											<div class="btn-group">
												<button class="btn btn-xs btn-success" title="Detail" onclick="location='<?php echo site_url("c_kia/detail_kia/".$vdt->id_reg); ?>'">
													<i class="ace-icon fa fa-search bigger-120"></i>
												</button>

												<!-- <button class="btn btn-xs btn-info" title="Edit" onclick="location='<?php //echo site_url("c_kia/form_kia/".$vdt->id_reg); ?>'">
													<i class="ace-icon fa fa-pencil bigger-120"></i>
												</button> -->

												<button class="btn btn-xs btn-primary" title="Status" onclick="location='<?php echo site_url("c_list/status_permohonan/".$vdt->id_reg."/kia"); ?>'">
													<i class="ace-icon fa fa-pencil bigger-120"></i>
												</button>

												<button class="btn btn-xs btn-danger" title="Hapus" onclick="location='<?php echo site_url("c_kia/delete_kia/".$vdt->id_reg); ?>'">

								...
								<div class="dataTables_length" id="DataTables_Table_0_length" style="margin-left: 10px;">
									<div class="form-group">
										<div class="col-sm-12">
											...
											<a class="btn btn-social btn-sm btn-facebook" href="<?php //echo site_url("c_list/form_mohon/kkbaru"); ?>">
					...
					<div class="col-md-12">
						...
						<table id="duatatuabel" class="table table-condensed table-bordered table-striped table-hover table-responsive" style="width: 100%">
							...
							<tbody>
								<?php
								$no = 1;
								foreach ($qdatap_online as $kdt => $vdt) {
								?>
									<tr>
										<td><?php echo $no++; ?></td>
										...
										<td>
											<div class="btn-group">
												<button class="btn btn-xs btn-success" title="Detail" onclick="location='<?php echo site_url("c_p_online/detail_p_online/".$vdt->id_reg); ?>'">
													<i class="ace-icon fa fa-search bigger-120"></i>
												</button>

												<button class="btn btn-xs btn-warning" title="Timeline" onclick="location='<?php echo site_url("c_p_online/timeline/".$vdt->id_reg); ?>'">
													<i class="ace-icon fa fa-comments bigger-120"></i>
												</button>

												<!-- <button class="btn btn-xs btn-info" title="Edit" onclick="location='<?php //echo site_url("c_p_online/form_p_online/".$vdt->id_reg); ?>'">
													<i class="ace-icon fa fa-edit bigger-120"></i>
												</button> -->

												<button class="btn btn-xs btn-primary" title="Status" onclick="location='<?php echo site_url("c_list/status_permohonan/".$vdt->id_reg."/p_online"); ?>'">
													<i class="ace-icon fa fa-pencil bigger-120"></i>
												</button>

												<button class="btn btn-xs btn-danger" title="Hapus" onclick="location='<?php echo site_url("c_p_online/delete_p_online/".$vdt->id_reg); ?>'">
